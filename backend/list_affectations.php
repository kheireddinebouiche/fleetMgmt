<?php
  ...
  if(isset($_SESSION["id"])){
      ...
      if($_SESSION["niveau"] == 1 or $_SESSION["niveau"] == 2){
          ...
          $req = mysqli_query($cnx, "SELECT * FROM suivie_affectation WHERE etat='en cours' or etat='pause' ORDER BY id DESC");
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Liste des affectations</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                        ...
                                        <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                            ...
                                            <?php 
                                                while($row=mysqli_fetch_array($req)){
                                                  ...
                                                  $sql_use = mysqli_query($cnx, "SELECT id,username FROM user WHERE id='$use' ");
                                                  $re = mysqli_fetch_assoc($sql_use);
                                              ?>     
                                                  <tr>
                                                      <td><?php echo $row["id"]; ?></td>
                                                      <td> <a href="details_utilisateur.php?id=<?php echo $re["id"]; ?> "><?php echo $re["username"]; ?> </a></td>
