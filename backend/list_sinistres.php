...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Fleet management | Liste des sinistres </title>
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Liste des sinistres</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Liste des sinistres</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                        ...
                                        <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                            ...
                                            <?php 
                                                while($row=mysqli_fetch_array($req)){
                                                  ...
                                                  echo "<td><center>
                                                            <a href='details_sinistre.php?id=$row[id]' class='btn btn-primary'>Détails</a> 
                                                            <a href='deactivate_sinistre.php?id=$row[id]' onclick='return checkDelete()' class='btn btn-danger'>Archiver</a>
                                                            </center>
                                                        </td>" ;
